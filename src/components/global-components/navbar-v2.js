...
import MyContext from "path-to-your-context"; // Replace with the actual path

const NavbarV2 = (props) => {
  // Assuming you are using the useContext hook somewhere in your code
  // Replace MyContext with the actual context you are using
  const myContextValue = useContext(MyContext);

  // Check if myContextValue is null before destructure
  const { basename } = myContextValue || {};
